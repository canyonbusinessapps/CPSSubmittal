<%@ Page Title="Create Submittals" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSubmittals.aspx.cs" Inherits="CBSSubmittal.Project.CreateSubmittals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Create Submittals</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="~/" runat="server">Home</a></li>
                        <li class="breadcrumb-item active">Create Submittals</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Submittals</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <asp:Button ID="btnCreateSubmittals" OnClick="btnCreateSubmittals_Click" CssClass="btn btn-md btn-primary" runat="server" Text="Submittals" />
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
