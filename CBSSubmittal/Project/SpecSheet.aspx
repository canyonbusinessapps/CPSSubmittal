        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceSpecSheet" runat="server" ConnectionString="<%$ ConnectionStrings:dbContext %>" SelectCommand="SELECT [Id], [DocumentName], substring([DocumentFile],11,250) AS DocumentFile FROM [SpecSheet]" DeleteCommand="DELETE FROM [SpecSheet] WHERE [Id] = @Id"></asp:SqlDataSource>
                </div>
                <!-- /.card-body -->
            </div>
        </div>
