        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:GridView ID="grdDocument" runat="server" AllowPaging="True" PageSize="20" OnPageIndexChanging="grdDocument_PageIndexChanging" AllowSorting="True" OnRowEditing="grdDocument_RowEditing" OnRowCancelingEdit="grdDocument_RowCancelingEdit" OnRowUpdating="grdDocument_RowUpdating" OnRowDeleting="grdDocument_RowDeleting" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="table table-striped table-bordered">
                        <Columns>
